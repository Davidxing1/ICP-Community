        ...
        <>
            <div>
                ...
                <div className="mt-16 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-5">
                    {spaces.map(item=>(
                        <button key={item.a} onClick={getproject} className="bg-gray-700  rounded-lg p-5 transform transition duration-300  hover:scale-105">
                            <div className="">
                                <img id={item.a} className="rounded-full mx-auto w-24 h-24"
                                     src={item.img} alt='' />
                            </div>
