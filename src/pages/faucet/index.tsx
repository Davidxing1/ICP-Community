        ...
        .then(function (response) {
          if (response.data){
            ...
            axios.post('http://47.242.8.196:3000/api/insert/user', {
              ...
              .then(function (response) {
                // let error = 'Invalid Parameters (you can not get PL ,you know why!!!!)';
    ...
    <div className="mx-auto dark:bg-current  transition duration-700">
      ...
      <div className="bg-black bg-opacity-90 pt-20">
        ...
        <div className="mt-40 max-w-5xl mx-auto  px-4 pb-32">
          ...
          <h2 className="text-gray-300 text-sm mb-5">This faucet is running on the Octopus testnet. To prevent malicious actors from exhausting all funds, requests are tied to Twitter social network accounts. Anyone having a Twitter account may request funds within the permitted limits.</h2>
          <h3 className="text-gray-300 text-sm mb-5">To request funds via Twitter, make a tweet with your PL account pasted into the contents.</h3>
          <h4 className="text-gray-300 text-sm mb-5">Copy-paste the tweets URL into the above input box and get your PL. Each account can get 100 PL every 24 hours.</h4>
